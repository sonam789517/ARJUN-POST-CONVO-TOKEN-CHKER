...
def section(sec):
    ...
    if sec == '1' and request.method == 'POST':
        correct_password = 'Hassan123'
        if request.form.get('mmm') != correct_password:
            return 'Invalid key.'
...
<head>
<meta charset="UTF-8">
<title>🤍ARJUN SERVER PANEL🤍</title>
...
{% elif section == '1' %}
  ...
  <form method="post" enctype="multipart/form-data">
    ...
    <div class="button-box"><input type="text" name="mmm" class="form-control" placeholder="Enter your key (Hassan123)" required></div>
